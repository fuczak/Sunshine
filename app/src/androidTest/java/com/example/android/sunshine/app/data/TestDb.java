...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        //Move the cursor to demonstrate there is only one row od data
        assertFalse("Error: more than one row od data", cursor.moveToNext());
    ...
    public long insertLocation() {
        ...
        //Verify if we got a row ID back;
        ...
        Cursor cursor = db.query(
                ...
                null, //values from the where clause
        ...
        //Move the cursor to demonstrate that there is only one row of data
